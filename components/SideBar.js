    ...
    <div className=" bg-white w-full mb-10 fixed z-10 top-0 left-0 p-2 ">
      <div className="bg-[#f1f1fb] py-4 px-4 pr-10 items-center justify-between w-full  rounded-md flex ">
        ...
        <div className=" flex space-x-6 items-center">
          {/* home component */}
          <div className='flex justify-between items-center p-2 space-x-2 cursor-pointer group transition-colors duration-100 ease-in hover:bg-black rounded-xl'>
                <div className='flex'>
          ...
          {/* about component */}
          <div className='flex justify-between items-center p-2 space-x-2 mr-10 cursor-pointer group transition-colors duration-100 ease-in hover:bg-black rounded-xl'>
                <div className='flex space-x-2'>
