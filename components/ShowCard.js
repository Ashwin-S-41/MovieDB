...
const ShowCard = ({results}) => {
  ...
  return (
    <div
      className="flex relative  mb-8 bg-black min-w-[170px] h-[240px] md:min-w-[150px] md:min-h-[200px] rounded-lg overflow-hidden cursor-pointer  hover:scale-105 transition duration-300"
